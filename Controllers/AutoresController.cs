...
namespace BibliotecFsa.Controllers
{
    public class AutoresController : Controller
    {
        ...
        public AutoresController(BibliotecaFsaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdAutor,Nombre,Apellido,Nacionalidad")] Autore autore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAutor,Nombre,Apellido,Nacionalidad")] Autore autore)
        {
